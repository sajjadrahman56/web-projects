...
<body>
  <div class="container mt-5">
    <?php
      ...
      echo "<h2 class='text-center'>History of Car Model: $car_model</h2>";
      ...
      if (count($attendanceRecords) > 0) {
        ...
        echo '<div class=" bg-dark row mt-5 text-center">
                <div class="col-md-5 text-danger">
                  <strong>Total Missing Days:</strong> ' . $absentCount . '
                </div>
        ...
        echo '<div class="row mt-5 bg-secondary text-center">
                <div class="col-md-5">
                  <strong>Present but no PAID  :  </strong> ' . $presentZeroCount . '
                </div>
               
        
                <div class="col-md-5">
                  <strong> D U E  :  </strong> ' . $presentZeroCount*10 . '
                </div>
              </div>';
      } else {
