        ...
        <div class="conatiner">
            <div class="row justify-content-center mt-5">
                <div class="col-lg-5 col-md-5 col-sm-6 text-secondary">
                    ...
                    <form action="dr_logInAction.php" method="post" id="loginForm">

                        <div class="mb-3">
                            <h3 class="text-center text-secondary">Log in as Driver</h3>
                        </div>
    
                        <div class="form-group row mt-2">
                            <div class="col-sm-12">
                                <input type="email" class="form-control" name="l_email" placeholder=" Email" required>
                            </div>
                        </div>
                        ...
                        <div   class="mt-2 p-2 " >
                            not register ? <a href="dri_reg.php">register</a>   
                        </div>
